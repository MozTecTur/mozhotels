package com.mozhotels.srit.web.websocket;

import com.mozhotels.srit.security.SecurityUtils;
import com.mozhotels.srit.web.websocket.dto.ActivityDTO;
...
import static com.mozhotels.srit.config.WebsocketConfiguration.IP_ADDRESS;
