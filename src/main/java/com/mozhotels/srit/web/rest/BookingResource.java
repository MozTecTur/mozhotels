...
public class BookingResource {
    ...
    @RequestMapping(value = "/bookings",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Booking>> getAllBookings(Pageable pageable, @RequestParam(required = false) String filter)
    ...
    public ResponseEntity<List<Booking>> searchBookings(@RequestParam String query, Pageable pageable)
        ...
        Page<Booking> page = bookingSearchRepository.search(queryStringQuery(query), pageable);
