...
public class InstanceRoomTypeResource {
    ...
    @RequestMapping(value = "/instance-room-types",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<InstanceRoomType>> getAllInstanceRoomTypes(Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of InstanceRoomTypes");
        Page<InstanceRoomType> page = instanceRoomTypeRepository.findAll(pageable); 
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/instance-room-types");
    ...
    @RequestMapping(value = "/_search/instance-room-types",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<InstanceRoomType>> searchInstanceRoomTypes(@RequestParam String query, Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to search for a page of InstanceRoomTypes for query {}", query);
        Page<InstanceRoomType> page = instanceRoomTypeSearchRepository.search(queryStringQuery(query), pageable);
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/instance-room-types");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
