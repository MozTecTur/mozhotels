    ...
    function stateConfig($stateProvider) {
        ...
        .state('tourist', {
            ...
            data: {
                ...
                pageTitle: 'mozhotelsApp.tourist.home.title'
            },
            views: {
                'content@': {
            ...
            resolve: {
                translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                    ...
                    $translatePartialLoader.addPart('aCountry');
                    $translatePartialLoader.addPart('aCountry');
                    $translatePartialLoader.addPart('hLanguage');
        ...
        .state('tourist-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'mozhotelsApp.tourist.detail.title'
            },
            views: {
                'content@': {
            ...
            resolve: {
                ...
                entity: ['$stateParams', 'Tourist', function($stateParams, Tourist) {
                    return Tourist.get({id : $stateParams.id});
                }]
            }
        })
        .state('tourist.new', {
