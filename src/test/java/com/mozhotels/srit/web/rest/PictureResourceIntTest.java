...
import com.mozhotels.srit.repository.PictureRepository;
import com.mozhotels.srit.repository.search.PictureSearchRepository;
...
public class PictureResourceIntTest {
    ...
    private static final LPictureType DEFAULT_TYPE = LPictureType.PROVINCE;
    private static final LPictureType UPDATED_TYPE = LPictureType.INSTANCETUR;
